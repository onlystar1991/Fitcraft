...
app.service('profileService',function() {
    ...
    return {
        ...
        setAvatar: function (avatar,avatar_sm) {
            profile.avatar = avatar;
            if(avatar_sm){
                $('.recent__activities .feeed_visible .icon img, .table__users__item.isactive img').attr('src','/uploads/icons/'+avatar_sm);
            }
        },
        getAvatar: function () {
...
app.controller('tooltipsCtrl',function($scope,userTooltipService){
