...
/* viewforum_body.html */
class __TwigTemplate_8f2807cda32232f413d85621aa4b326fc9d6618f045c607d0b5927372bd28a71 extends Twig_Template
{
...
";
        ...
        $this->loadTemplate("overall_footer.html", "viewforum_body.html", 250)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
