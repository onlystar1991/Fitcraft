...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    /**
     * Gets the 'auth.provider.bridgebb' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \laravel\bridgebb\auth\provider\bridgebb A laravel\bridgebb\auth\provider\bridgebb instance.
     */
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'zzBB_oauth_tokens', 'zzBB_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'zzBB_users', $this, './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'zzBB_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'zzBB_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'zzBB_forums', 'zzBB_posts', 'zzBB_topics', 'zzBB_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('zzBB_captcha_questions', 'zzBB_captcha_answers', 'zzBB_qa_confirm');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'fitcraft', '111fitcraft111', 'fitcraft_forum', '3306', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'zzBB_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'zzBB_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'zzBB_migrations', './', 'php', 'zzBB_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'zzBB_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'zzBB_notification_types', 'zzBB_notifications', 'zzBB_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'zzBB_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'zzBB_profile_fields', 'zzBB_profile_lang', 'zzBB_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'zzBB_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'zzBB_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'zzBB_oauth_accounts',
            'tables.captcha_qa_questions' => 'zzBB_captcha_questions',
            'tables.captcha_qa_answers' => 'zzBB_captcha_answers',
            'tables.captcha_qa_confirm' => 'zzBB_qa_confirm',
            'tables.config' => 'zzBB_config',
            'tables.config_text' => 'zzBB_config_text',
            'tables.ext' => 'zzBB_ext',
            'tables.forums' => 'zzBB_forums',
            'tables.log' => 'zzBB_log',
            'tables.migrations' => 'zzBB_migrations',
            'tables.modules' => 'zzBB_modules',
            'tables.notification_types' => 'zzBB_notification_types',
            'tables.notifications' => 'zzBB_notifications',
            'tables.profile_fields' => 'zzBB_profile_fields',
            'tables.profile_fields_data' => 'zzBB_profile_fields_data',
            'tables.profile_fields_options_language' => 'zzBB_profile_fields_lang',
            'tables.profile_fields_language' => 'zzBB_profile_lang',
            'tables.posts' => 'zzBB_posts',
            'tables.topics' => 'zzBB_topics',
            'tables.user_notifications' => 'zzBB_user_notifications',
            'tables.users' => 'zzBB_users',
            ...
            'core.table_prefix' => 'zzBB_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysqli',
            'dbal.dbhost' => 'localhost',
            'dbal.dbuser' => 'fitcraft',
            'dbal.dbpasswd' => '111fitcraft111',
            'dbal.dbname' => 'fitcraft_forum',
            'dbal.dbport' => '3306',
            'dbal.new_link' => false,
        );
    }
