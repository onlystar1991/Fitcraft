            ...
            <div class="register-from-area tab-content">
                ...
                <div class="text-center register-form tab-pane active"  id="tab1" >                        
                        ...
                        <div class="clearfix row-register">
                           ...
                           <input class="form-control form-input pull-left input-register input-email-register"
...
<!--                             <div class="pull-left">
                              <div class="styled-select">
                                  <select name="ft" class="form-control form-input styled-select styled-select__height">
                                      <option value=""></option>
                                      <?php for ($i=1; $i <=6 ; $i++) { 
                            ...
                            <div class="pull-left">
                                <select name="ft" class="required form-input cs-select cs-skin-border"> 
                                    <option value=""></option>                                   
                                    <?php for ($i=1; $i <=6 ; $i++) { 
                                        echo "<option value='$i' >$i</option>";
                                    } ?>
                            ...
                            <div class="pull-left">
                                <div class="styled-select">
                                   <select name="inch" class="form-control form-input styled-select styled-select__height">
                                      <option value=""></option>
                                      <?php for ($i=0; $i <=11 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                    ...
                    <div class="clearfix row-item row-item--register-modal">
                        ...
                        <div class="row-item__content row-item__content--register-modal pull-left">
                            <div class="pull-left">
                                <div class="styled-select">
                                   <select name="lbs" class="form-control form-input styled-select styled-select__height">
                                      <option value=""></option>
                                      <?php for ($i=0; $i <=350 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                    ...
                    <div class="clearfix row-item row-item--register-modal">
                        ...
                        <div class="row-item__content row-item__content--register-modal pull-left">
                            <div class="pull-left">
                                <div class="styled-select">
                                   <select name="body_fat" class="form-control form-input styled-select styled-select__height">
                                      <option value=""></option>
                                      <?php for ($i=0; $i <=65 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                    ...
                    <div class="clearfix row-item row-item--register-modal">
                        ...
                        <div class="row-item__content row-item__content--register-modal pull-left">
                            <div class="pull-left">
                                <div class="styled-select">
                                   <select name="day" class="form-control form-input styled-select__height">
                                      <option value=""></option>
                                      <?php for ($i=1; $i <=31 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                            ...
                            <div class="pull-left">
                                <div class="styled-select">
                                   <select name="month" class="form-control form-input styled-select__height">
                                      <option value=""></option>
                                      <?php for ($i=1; $i <13 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                            ...
                            <div class="pull-left ">
                                <div class="styled-select">
                                   <select name="year" class="form-control form-input styled-select__year">
                                      <option value=""></option>
                    ...
                    <div class="clearfix row-item row-item--register-modal">
                        ...
                        <div class="row-item__content row-item__content--register-modal pull-left">
                            <div class="pull-left">
                                <div class="styled-select">
                                   <select name="gender" class="form-control form-input styled-select__gender">
                                      <option value=""></option>                                      
                ...
                <div class="text-center register-form tab-pane register-form--step3"  id="tab3" >                        
                    <div class="clearfix row-register row-register--athlete-name">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <input class="form-control form-input pull-left input-athlete-name input-athlete-register" type="text" name="athlete_name" value="" autocomplete="off" >
