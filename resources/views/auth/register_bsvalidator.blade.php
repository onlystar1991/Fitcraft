          ...
          <div class="register-modal__steps">
            ...
            <div class="register-from-area tab-content">
                ...
                <div class="text-center register-form tab-pane active"  id="tab1" >                        
                        <div class="clearfix row-register form-group">
...
<!-- bootstrapValidator -->
{!! HTML::style('assets/js/lib/bwizard/bootstrapValidator.css') !!}

{!! HTML::script('assets/js/lib/bwizard/jquery-1.10.2.min.js') !!}
{!! HTML::script('assets/js/lib/bwizard/bootstrap.min.js') !!}
{!! HTML::script('assets/js/lib/bwizard/bootstrapValidator.js') !!}
