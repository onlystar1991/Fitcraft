                ...
                <div class="text-center register-form tab-pane register-form--step2"  id="tab2" >                        
                    <div class="clearfix row-item row-item--register-modal">
                        ...
                        <div class="row-item__content row-item__content--register-modal pull-left">
                            ...
                            <div class="pull-left">                                
                                   <select name="inch" class="form-input">
                                      <option value=""></option>
                                      <?php for ($i=0; $i <=11 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                    ...
                    <div class="clearfix row-item row-item--register-modal">
                        ...
                        <div class="row-item__content row-item__content--register-modal pull-left">
                            <div class="pull-left">
                                   ...
                                   <select name="body_fat" class="fform-input cs-select cs-skin-border">
                                      <option value=""></option>
                                      <?php for ($i=0; $i <=65 ; $i++) { 
                                          echo "<option value='$i' >$i</option>";
                                      } ?>
                ...
                <div class="text-center register-form tab-pane register-form--step3"  id="tab3" >                        
                    <div class="clearfix row-register row-register--athlete-name">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <input class="form-control form-input pull-left input-athlete-name" type="text" name="athlete_name" value="" autocomplete="off" >
