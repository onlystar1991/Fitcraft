...
@if ( !Auth::client()->check() )
    <div class="login-modal clearfix pr">
            ...
            <div class="text-center login-form">
                {!! Form::open() !!}
                    <div class="clearfix row-login">
                       <div class="pull-left label-login ">ACCOUNT NAME</div>
                    ...
                    <div class="clearfix row-login">
                        ...
                        <span>
                            ...
                            <label for="saveLogin"><span></span></label> <span class="login-modal__remember-text">SAVE LOGIN</span>
                        </span>
                    </div>
                    @if (count($errors) > 0)
