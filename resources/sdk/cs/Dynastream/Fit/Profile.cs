...
namespace Dynastream.Fit
{
   ...
   public static class Profile
   {
      ...
      {                                                             
         ...
         subfieldIndex = 0;
         metZoneMesg.fields[fieldIndex].subfields.Add(new Subfield("LowAlertElevation", 132, 5f, 500f, "m"));
         metZoneMesg.fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 0);
         subfieldIndex++;
         metZoneMesg.fields[fieldIndex].subfields.Add(new Subfield("HighAlertElevation", 132, 5f, 500f, "m"));
         metZoneMesg.fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 0);
         subfieldIndex++;
         fieldIndex++;         
